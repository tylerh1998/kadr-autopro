  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2">Payroll Trends</h1>
          <p className="text-slate-600 dark:text-slate-400">Analyze payroll costs, labor distribution, and year-over-year comparisons</p>
        </div>
      </div>
