...
import { Plus, Search, FileText, Calendar, RefreshCw, Wrench, Clock, Users, AlertTriangle, CheckCircle, Link as LinkIcon, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function WorkOrdersPage() {
  ...
  const getWOCountByStatus = (stage, statusName) => {
    return workOrders.filter(wo => {
      const stageMatch = wo.stage === stage;
      if (statusName === 'all') return stageMatch;
      return stageMatch && wo.status === statusName;
    }).length;
  };
