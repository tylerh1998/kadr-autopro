...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-400 flex items-center justify-center p-4 relative">
      <div className="w-full max-w-sm rounded-2xl shadow-2xl relative z-10 overflow-hidden">
        {/* Program Navigation Tabs */}
        <div className="flex w-full text-center text-[11px] sm:text-xs font-bold">
          <div className="flex-1 py-2.5 bg-white text-black select-none">
            AutoPRO
          </div>
          <a
            href="https://workpro.kensauto.ca"
            className="flex-1 py-2.5 bg-[#167830] text-white hover:bg-white hover:text-black transition-all duration-150"
          >
            WorkPRO
          </a>
          <a
            href="https://my.kensauto.ca"
            className="flex-1 py-2.5 bg-[#1c2c54] text-white hover:bg-white hover:text-black transition-all duration-150"
          >
            myKADR Account
          </a>
        </div>
