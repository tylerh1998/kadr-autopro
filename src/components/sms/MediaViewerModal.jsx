...
import { X, Download, ZoomIn, ZoomOut, RotateCw, RefreshCw, Share2 } from 'lucide-react';
...
export default function MediaViewerModal({ isOpen, onClose, mediaUrl, mediaType, mediaName, onShare }) {
