        ...
        <div className="py-4 space-y-6">
          {loading && (
            <div className="text-center py-8">
              ...
              <p className="mt-2 text-slate-600">Loading WorkPRO data...</p>
            </div>
          )}
          ...
          {!loading && !project && (
            <Card className="border-2 border-dashed border-slate-300">
              <CardContent className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-slate-700 mb-2">No WorkPRO Project Connected</h3>
          ...
          {!loading && project && (
            <>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="text-sm font-medium text-slate-600">Assigned Employees</label>
                      <p>{project.employee_assigned || 'Not assigned'}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-slate-600">Time Estimate</label>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-slate-700">{project.name || 'No task defined'}</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-slate-700 whitespace-pre-wrap">{project.description || 'No description provided'}</p>
                </CardContent>
              </Card>
                  ...
                  <CardContent>
                    <div className="flex items-center gap-4">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-slate-900">{project.time_estimate} hours</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
