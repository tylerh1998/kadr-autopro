...
- [x] **Balance Sheet, P&L, and Financial Dashboard** — **P&L + Dashboard PASSED (2026-08-08)**; Balance Sheet tab not separately opened
  ...
  **Result:** `FinancialDashboard.jsx` loaded with a real Cash Flow Trend chart (real weekly cash in/out/running-balance data). Its "Profit & Loss" tab loaded real revenue-by-account data (`4000 Sales Revenue $11,200.58`, `4001 Labour $4,342.00`, etc.). Balance Sheet tab exists in the same page but wasn't clicked into this session.
