...
### Phase 2 — Server-side enforcement: reject edit/delete on locked or paid rows [Pending]
...
### Phase 3 — Wire "Add to Cash Flow" to actually lock the selected rows [Pending]
...
### Phase 4 — Client-side: show the lock, disable controls, pre-select in Make Payment [Pending]
...
### Phase 5 — Payment/cancellation handoff, cash-sheet delete path, full verification [Pending]
